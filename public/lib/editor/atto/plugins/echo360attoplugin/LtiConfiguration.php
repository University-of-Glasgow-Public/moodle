...
require_once($CFG->dirroot.'/lib/editor/atto/plugins/echo360attoplugin/LtiUserRoles.php');
...
class LtiConfiguration {
    ...
    public function __construct($context, $pluginname, $pagetype = '') {
        ...
        // LTI 1.1 configuration settings generated by Echo360 admin configurations page.
