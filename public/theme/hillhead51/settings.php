...
/**
 * UofG Hillhead 5.1 theme settings
 *
...
// The GUID Report link now lives in the Reports tab.
if ($hassiteconfig) {
    $reportnname = get_string('guid-report', 'theme_hillhead51');

    $ADMIN->add('reports', new admin_externalpage('guid-report',
        $reportnname,
...
if ($ADMIN->fulltree) {
    $currenttheme = 'theme_hillhead51';

    // Boost provides a nice setting page which splits settings onto separate tabs. We want to use it here.
    $settings = new theme_boost_admin_settingspage_tabs(
        'themesettinghillhead51', get_string('configtitle', $currenttheme));
    ...
    $choices['mint.scss'] = 'Mint Green';
    $choices['glaucous.scss'] = 'Glaucous Blue';
    $choices['saffron.scss'] = 'Saffron Yellow';
    ...
    $name = 'theme_hillhead51/loginbackgroundimage';
    ...
    $setting->set_updatedcallback('theme_hillhead51_update_settings_images');
    ...
    $name = 'theme_hillhead51/hillhead_student_course_alert';
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead51/hillhead_student_course_alert_text',
    ...
    $name = 'theme_hillhead51/hillhead_old_browser_alerts';
    ...
    $name = 'theme_hillhead51/hillhead_notification_type';
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead51/hillhead_notification',
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead51/scsspre',
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead51/scss',
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead51/login_intro',
