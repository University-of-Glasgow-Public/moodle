...
$allowedpreferences = [
    'theme_hillhead51_accessibility'  => true,
    'theme_hillhead51_contrast'       => true,
    'theme_hillhead51_font'           => true,
    'theme_hillhead51_bold'           => true,
    'theme_hillhead51_spacing'        => true,
...
if (array_key_exists($setting, $allowedpreferences)) {
    ...
    if ($setting == 'theme_hillhead51_reset_accessibility') {
        foreach ($allowedpreferences as $unset => $pointlesstrue) {
            if ($unset != 'theme_hillhead51_accessibility') {
