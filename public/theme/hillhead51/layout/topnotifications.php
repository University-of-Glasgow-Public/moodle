 ...
 *
 * Based on the settings in /admin/settings.php?section=themesettinghillhead51
...
$themetype = 'hillhead51';
$hillheadnotificationtype = get_config('theme_hillhead51', 'hillhead_notification_type');
$hillheadnotificationtext = get_config('theme_hillhead51', 'hillhead_notification');
...
$hillheadoldbrowseralerts = get_config('theme_hillhead51', 'hillhead_old_browser_alerts');
...
if ($PAGE->pagetype == 'my-index') {
    ...
    $dashboardnotification = get_config('theme_hillhead51', 'hillhead_student_course_alert');

    if ($dashboardnotification == 'enabled') {
        $notiftext .= '<div class="alert alert-info alert-jumbo"><a class="close" href="' . $CFG->wwwroot;
        $notiftext .= '/theme/hillhead51/notification.php?h=' . md5('DashboardNoCourseWarning');
        $notiftext .= '" aria-label="Close"><span aria-hidden="true">&times;</span></a><span class="d-flex-item">';
        $notiftext .= get_config('theme_hillhead51', 'hillhead_student_course_alert_text') . '</span></div>';
    }
}
