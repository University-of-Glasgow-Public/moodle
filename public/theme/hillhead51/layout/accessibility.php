...
if ($themehillhead51spacing == 'on') {
    $spacingoptions = [
        [
            'o' => 'theme_hillhead51_spacing',
            'v' => 'clear',
            'c' => 'hh-acc-sp-of',
...
if ($themehillhead51stripstyles == 'on') {
    $stripstyleoptions = [
        [
            'o' => 'theme_hillhead51_stripstyles',
            'v' => 'clear',
            'c' => 'hh-acc-ss-of',
...
if ($usesaccessibilitytools) {
    ...
    $acctxt .= '<span class="float-right"><a href="' . $CFG->wwwroot . '/theme/hillhead51/accessibility.php?o=';
    $acctxt .= 'theme_hillhead51_reset_accessibility&v=yes" class="mr-2" data-key="accessibility"><i class="fa fa-refresh"></i>';
    $acctxt .= 'Reset All</a>';
    $acctxt .= '<a href="' . $CFG->wwwroot . '/theme/hillhead51/accessibility.php?o=theme_hillhead51_accessibility&v=clear" ';
    ...
    foreach ($colouroptions as $opt) {
        ...
        $acctxt .= '/theme/hillhead51/accessibility.php?o=' . $opt['o'] . '&v=' . $opt['v'] . '"><i class="fa ' . $opt['i'] . '">';
        $acctxt .= '</i>' . $opt['t'] . '</a></li>';
    }
    $acctxt .= '</ul>';
    $acctxt .= '<h4>Simple Themes</h4><ul class="accessibility-features">';
    foreach ($accessiblecolouroptions as $opt) {
        $acctxt .= '<li><a class="hh-acc" id="' . $opt['c'] . '" href="' . $CFG->wwwroot . '/theme/hillhead51/accessibility.php?o=';
