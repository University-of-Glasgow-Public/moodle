...
class theme_hillhead_core_renderer extends core_renderer {
    ...
    protected function render_custom_menu(custom_menu $menu) {
        if (isloggedin()) {
            ...
            $script = '/theme/hillhead/accessibility.php';
 ...
 *
 * @package   theme_hillhead
 * @copyright 2026 Glasgow University
 ...
 */
class theme_hillhead_core_course_renderer extends core_course_renderer {
    ...
    public function course_category($category) {
        ...
        $site = get_site();
        $actionbar = new \theme_hillhead\output\theme_hillhead_category_action_bar($this->page, $coursecat);
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_hillhead_core_course_management_renderer extends core_course_management_renderer {
