...
/**
 * UofG Hillhead 5.2 theme settings
 *
...
if ($hassiteconfig) {
    $reportnname = get_string('guid-report', 'theme_hillhead');
...
if ($ADMIN->fulltree) {
    $currenttheme = 'theme_hillhead';

    // Boost provides a nice setting page which splits settings onto separate tabs. We want to use it here.
    $settings = new theme_boost_admin_settingspage_tabs(
        'themesettinghillhead', get_string('configtitle', $currenttheme));
    ...
    $name = 'theme_hillhead/loginbackgroundimage';
    ...
    $setting->set_updatedcallback('theme_hillhead_update_settings_images');
    ...
    $setting = new admin_setting_configtextarea('theme_hillhead/scss',
