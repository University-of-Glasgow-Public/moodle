...
if ($themehillheadreadhighlight == 'on') {
...
if ($usesaccessibilitytools) {
    ...
    $acctxt .= '<span class="float-right"><a href="' . $CFG->wwwroot . '/theme/hillhead/accessibility.php?o=';
    $acctxt .= 'theme_hillhead_reset_accessibility&v=yes" class="mr-2" data-key="accessibility"><i class="fa fa-refresh"></i>';
    $acctxt .= 'Reset All</a>';
    $acctxt .= '<a href="' . $CFG->wwwroot . '/theme/hillhead/accessibility.php?o=theme_hillhead_accessibility&v=clear" ';
    ...
    foreach ($colouroptions as $opt) {
        ...
        $acctxt .= '/theme/hillhead/accessibility.php?o=' . $opt['o'] . '&v=' . $opt['v'] . '"><i class="fa ' . $opt['i'] . '">';
        $acctxt .= '</i>' . $opt['t'] . '</a></li>';
    }
    $acctxt .= '</ul>';
    $acctxt .= '<h4>Simple Themes</h4><ul class="accessibility-features">';
    foreach ($accessiblecolouroptions as $opt) {
        $acctxt .= '<li><a class="hh-acc" id="' . $opt['c'] . '" href="' . $CFG->wwwroot . '/theme/hillhead/accessibility.php?o=';
