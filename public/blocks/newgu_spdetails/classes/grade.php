    ...
    int|null $scaleid = null): string {
        ...
        switch ($gradetype) {
            ...
            case GRADE_TYPE_SCALE:
                ...
                // MGU-1386 - When the grade can't be mapped to the scale - return an error.
                if (!$returngrade = $scale->get_nearest_item($grade)) {
                    $returngrade = get_string('configerror', 'block_newgu_spdetails');
                }
                break;
