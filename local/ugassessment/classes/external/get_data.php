    ...
    public static function execute_returns() {
        ...
        'data' => new external_multiple_structure(
            new external_single_structure([
                ...
                'coursesubject' => new external_value(PARAM_TEXT, 'Course subject', VALUE_OPTIONAL),
                'coursevisible' => new external_value(PARAM_BOOL, 'Course visible'),
                'academicyear' => new external_value(PARAM_TEXT, 'Academic year'),
                'qualification' => new external_value(PARAM_TEXT, 'Qualification', VALUE_OPTIONAL),
                'semester' => new external_value(PARAM_TEXT, 'Semester', VALUE_OPTIONAL),
                'studentmygrades' => new external_value(PARAM_TEXT, 'Student My Grades Boolean'),
                ...
                'tags' => new external_value(PARAM_TEXT, 'Comma-separated list of tags', VALUE_OPTIONAL),
